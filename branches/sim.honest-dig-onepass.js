...
/* The bucket holds what one pass of its own teeth cuts: its width, its
   depth of cut, and the length of a pass. It is not a number any more, it
   is a consequence, and it comes out at about five and a half cubic metres
   for a six-metre machine - which is large for a real telehandler and small
   for what this was. Set in applyScale, because it depends on how big the
   machine is at this scale. */
var BUCKET=26;
...
function applyScale(def,carry,fresh){
  ...
  BUCKET=BLADE_W*machLen*CUT_MAX*(PASS*machLen);
